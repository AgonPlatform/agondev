...
static VDU_A_B_CMD_x_y vdu_return_ascii_code_at_position = { 23, 0, 0x83, 0, 0 };
...
uint8_t vdp_return_ascii_code_at_position( int x, int y )
{
	...
	vdu_return_ascii_code_at_position.x = x;
	vdu_return_ascii_code_at_position.y = y;
	VDP_PUTS( vdu_return_ascii_code_at_position );
